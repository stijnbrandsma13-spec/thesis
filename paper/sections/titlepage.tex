...
\begin{abstract}
    \noindent The FKRB estimator, proposed by \citet{FoxKimRyanBajari2011}, provides a computationally tractable way to estimate the latent class multinomial logit model.
    ...
    This thesis evaluates the finite-sample coverage of confidence intervals for the FKRB estimator through a Monte Carlo simulation across five data generating processes that vary the distribution of random coefficients, two sample sizes, and two grid sizes.
