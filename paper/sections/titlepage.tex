...
\begin{abstract}
    ...
    At small grid sizes the standard FKRB procedure is found to be statistically indistinguishable from optimal for off-boundary distributions, and conservative for on-boundary distributions.
    At large grid sizes the FKRB procedure often produces incorrect confidence intervals. 
    The sieve Wald and QLR procedures are quite conservative for all distributional specifications.
\end{abstract}
